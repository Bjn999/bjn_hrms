      ...
      <div className="flex justify-between items-start mb-8 flex-wrap gap-4">
        <div>
          <div className="flex items-center gap-3 mb-1">
            <Link href="/portal/absences" className="p-2 rounded-xl hover:bg-slate-100 transition-colors text-slate-500">
          ...
          <div className="flex items-center gap-3">
            <Link
              href={`/portal/absences/print/${monthId}`}
              target="_blank"
