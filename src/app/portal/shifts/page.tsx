...
export default function ShiftsPage() {
  ...
  const handleChange = (e: React.ChangeEvent<HTMLInputElement | HTMLSelectElement>) => {
    ...
    if (name === 'from_time' || name === 'to_time') {
      updatedForm.total_hour = calculateHours(
        name === 'from_time' ? value : formData.from_time,
        name === 'to_time' ? value : formData.to_time
      );
    }
  ...
  const handleDelete = async (id: number) => {
    const isConfirmed = await confirm({
      ...
      description: 'هل أنت متأكد من رغبتك في حذف هذا النوع من الشفتات؟',
      icon: 'danger'
    });
