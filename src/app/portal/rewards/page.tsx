  ...
  return (
    <div className="animate-fade-in-up pb-10">
      <div className="flex justify-between items-end mb-8">
        <div>
          <h2 className="text-3xl font-black text-slate-800 tracking-tight">المكافآت المالية</h2>
          <p className="text-slate-500 mt-1 text-sm">إدارة السجلات الخاصة بالمكافآت المالية مقسمة حسب الأشهر المالية</p>
        </div>
      </div>
