...
export default function RewardsPrintPage() {
  const { t } = useLanguage();
    ...
    <div className="bg-white min-h-screen p-8 text-black" dir="rtl">
      ...
      <div className="flex justify-between items-center border-b-2 border-black pb-4 mb-6">
        ...
        <div className="text-right w-1/3">
          ...
          <h2 className="text-xl font-bold mt-2">كشف مكافآت الموظفين</h2>
        </div>
      ...
      <table className="w-full text-sm border-collapse border border-black text-center">
        <thead>
          <tr className="bg-gray-100">
            ...
            <th className="border border-black p-2 font-bold">نوع المكافأة</th>
            <th className="border border-black p-2 font-bold">القيمة/الأيام</th>
            <th className="border border-black p-2 font-bold">الإجمالي المالي</th>
