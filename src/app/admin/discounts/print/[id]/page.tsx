...
import { FinanceMonth, Discount } from '@/types';
...
export default function DiscountsPrintPage() {
  const { t } = useLanguage();
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const res = await fetch(`${API}/discounts/${monthId}`, { headers });
    ...
    <div className="bg-white min-h-screen p-8 text-black" dir="rtl">
      ...
      <div className="flex justify-between items-center border-b-2 border-black pb-4 mb-6">
        ...
        <div className="text-right w-1/3">
          ...
          <h2 className="text-xl font-bold mt-2">كشف خصومات الموظفين</h2>
        </div>
